...
shadow_thing_name = "car_heater"
shadow_property = "state"
...
def exit(msg_or_exception=None):
...
def on_shadow_delta_updated(callback):
    def handler(delta):
...
def connect_iot(update_callback):
    ...
    try:
        ...
        delta_subscribed_future, _ = shadow_client.subscribe_to_shadow_delta_updated_events(
            ...
            qos=mqtt.QoS.AT_LEAST_ONCE,
            callback=on_shadow_delta_updated(update_callback))
